...
export default function OpenAndCloseServiceTicket() {
    ...
    const handleSubmit = (userInputs: any) => {
        ...
        customApiClient.cimOpenAndCloseTicket(payload).then((_) => redirect(`/tickets/${id}/`));
    };
    ...
    return (
        <EuiPage css={formStyling}>
            <EuiPageBody component="div">
                <FormHeader
                    title="Prepare to send OPEN and CLOSE email to institutes"
                    explainTitle="What is this?"
                    explainDescription={
                        <p>
                            This wizard will guide you through the process of sending the OPEN email to institutes,
                            Whilst immediately closing the ticket.
                        </p>
                    }
                />
                <OpenForm
                    formKey="open_and_close_ticket_form"
