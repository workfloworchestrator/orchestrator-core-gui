...
I18n.translations.en = {
    ...
    process: {
        ...
        source_vlan_1_info: "VLAN range - must be integer [2-4095]",
        ...
        destination_vlan_1_info: "VLAN range - must be integer [2-4095]",
        ...
        source_vlan_2_info: "VLAN range - must be integer [2-4095]",
        ...
        destination_vlan_2_info: "VLAN range - must be integer [2-4095]",
        capacity: "Capacity",
        ...
        location_code_1: "First MSP location code",
        location_code_1_info: "Provide a valid location code",
        location_code_2: "Second MSP location code",
        location_code_2_info: "Provide a valid location code",
        crm_port_id: 'The CRM identifier for a port',
        crm_port_id_info: 'Provide a valid, 5 digit, CRM Port ID (Surfnet7)',
        crm_port_id_1: 'First MSP the CRM identifier for a port',
        crm_port_id_1_info: 'Provide a valid, 5 digit, CRM Port ID (Surfnet7)',
        ...
        ieee_interface_type_1: "First MSP IEEE interface type",
        ieee_interface_type_1_info: "Choose an IEEE interface type",
        ieee_interface_type_2: "Second MSP IEEE interface type",
        ieee_interface_type_2_info: "Choose an IEEE interface type",
        ...
        nms_service_id_1_info: "The id of the ethernet service on the network (0000-9999)",
        nms_service_id_2: "NMS service id of the second lightpath",
        nms_service_id_2_info: "The id of the ethernet service on the network (0000-9999)",
