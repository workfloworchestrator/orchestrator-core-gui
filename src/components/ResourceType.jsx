    ...
    submit = e => {
        ...
        if (!invalid) {
            ...
            saveResourceType(resourceType).then(() => {
                this.props.history.push("/metadata/resource_types");
                setFlash(
                    I18n.t(resourceType.resource_type_id ? "metadata.flash.updated" : "metadata.flash.created", {
                        type: "Resource Type",
                        name: resourceType.resource_type
                    })
                );
        ...
        return (
            <section className="buttons">
                ...
                {resourceType.resource_type_id && (
                    <button className="button red" onClick={this.handleDeleteResourceType}>
        ...
        return (
            <div className="mod-resource-type">
                ...
                <section className="card">
                    {formInput(
                        "metadata.resourceTypes.resource_type",
                        "resource_type",
                        resourceType.resource_type || "",
                        readOnly,
                        this.state.errors,
                        this.changeProperty("resource_type"),
                        this.validateProperty("resource_type"),
                        duplicateName ? I18n.t("metadata.resourceTypes.duplicate_name") : null
                    )}
                    {formInput(
                        "metadata.resourceTypes.description",
                        "description",
