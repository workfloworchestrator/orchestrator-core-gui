...
export default class StyleGuide extends React.PureComponent<IProps, IState> {
    ...
    renderExplain() {
        return (
            <div onClick={() => this.setState({ showExplanation: true })}>
                ...
                <EuiPageBody component="div">
                    ...
                    <EuiText grow={true}>
                        ...
                        <p>
                            ...
                            end of the western spiral arm of the Galaxy lies a small unregarded yellow sun. When
                            suddenly some wild JavaScript code appeared! <code>const whoa = &quot;!&quot;</code>
                        </p>
                        <pre>
