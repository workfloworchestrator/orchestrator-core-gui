...
import { ImsNodeIdField, SelectField } from "custom/uniforms";
...
describe("<ImsNodeIdField>", () => {
    test("<ImsNodeIdField> - shows loading placeholder", async () => {
        mock.onGet("surf/ims/nodes/kb001a/PL?unsubscribed_only=true").reply(200, []);
    ...
    test("<ImsNodeIdField> - calls selectField with all nodes", async () => {
        mock.onGet("surf/ims/nodes/kb001a/PL?unsubscribed_only=true").reply(200, [{ id: 1, name: "Some Node" }]);
    ...
    test("<ImsNodeIdField> - calls api with right status", async () => {
        mock.onGet("surf/ims/nodes/kb001a/IS?unsubscribed_only=true").reply(200, [{ id: 1, name: "Some Node" }]);
